...
//+kubebuilder:rbac:groups=syn.servicenow.com,resources=changerequests,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=syn.servicenow.com,resources=changerequests/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=syn.servicenow.com,resources=changerequests/finalizers,verbs=update
